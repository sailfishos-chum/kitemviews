...
%{_opt_kf5_libdir}/libKF5ItemViews.so.*
%{_opt_kf5_qtplugindir}/designer/*5widgets.so
%{_opt_kf5_datadir}/locale/

%files devel

%{_opt_kf5_includedir}/KF5/KItemViews/
%{_opt_kf5_libdir}/libKF5ItemViews.so
%{_opt_kf5_libdir}/cmake/KF5ItemViews/
%{_opt_kf5_archdatadir}/mkspecs/modules/qt_KItemViews.pri
